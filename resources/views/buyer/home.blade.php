...
@section('content')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                ...
                <div class="order-2 md:order-1 text-center md:text-left">
                    ...
                    <div class="flex gap-3 justify-center md:justify-start">
                        <button
                            class="btn bg-amber-600 hover:bg-amber-700 text-white border-none rounded-full px-8 shadow-lg shadow-amber-200">
                            Pesan Sekarang
                        </button>
                ...
                <div class="order-1 md:order-2">
                    <img src="https://images.unsplash.com/photo-1558961363-fa8fdf82db35?q=80&w=1000" alt="Hero Image"
    ...
    <div class="container mx-auto px-4 md:px-8 py-8">
        <div class="flex justify-between items-end mb-6">
            ...
            <a href="{{ route('produk') }}"
                class="text-amber-600 text-sm font-semibold hidden md:block hover:underline">Lihat Semua Produk</a>
        </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
            ...
            @forelse($best_sellers as $item)
                <div
                    class="group bg-white border border-gray-100 rounded-xl p-3 md:p-4 shadow-sm hover:shadow-xl transition duration-300">
                    ...
                    <div class="relative aspect-square bg-gray-100 rounded-lg mb-3 overflow-hidden">
                        ...
                        {{-- Badge Best Seller --}}
                        <span
                            class="absolute top-2 right-2 bg-amber-500 text-white text-[10px] font-bold px-2 py-1 rounded shadow">BEST</span>
                    </div>
            ...
            @forelse($new_products as $item)
                <div
                    ...
                    <div class="relative aspect-square bg-gray-100 rounded-lg mb-3 overflow-hidden">
                        ...
                        {{-- Badge New --}}
                        <span
                            class="absolute top-2 right-2 bg-blue-500 text-white text-[10px] font-bold px-2 py-1 rounded shadow">NEW</span>
                    </div>
