...
@section('content')
    ...
    <div class="container mx-auto px-4 md:px-8 py-4">
        <div class="text-sm breadcrumbs">
            <ul>
                <li><a href="/" class="text-amber-600 hover:underline"><i class="fa-solid fa-home"></i> Beranda</a></li>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div class="order-1 md:order-2">
                ...
                <div class="space-y-4 text-gray-600 leading-relaxed">
                    <p>
                        Berawal dari kecintaan mendalam terhadap kuliner tradisional Yogyakarta, kami hadir dengan misi sederhana: 
                        menghadirkan kehangatan dan kelezatan khas Jogja ke setiap rumah di Indonesia.
                    </p>
                    <p>
                        Setiap produk yang kami tawarkan bukan sekadar makanan, tetapi juga cerita tentang warisan resep turun-temurun 
    ...
    <div class="container mx-auto px-4 md:px-8 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8">
            ...
            {{-- Visi --}}
            <div class="bg-white border border-gray-100 rounded-xl p-6 md:p-8 shadow-sm hover:shadow-xl transition duration-300">
    ...
    <div class="container mx-auto px-4 md:px-8 py-8 pb-12">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-8">
            ...
            {{-- Value 1 --}}
            <div class="group bg-white border border-gray-100 rounded-xl p-4 md:p-6 shadow-sm hover:shadow-xl transition duration-300 text-center">
                <div class="w-14 h-14 md:w-16 md:h-16 bg-amber-100 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition duration-300">
            ...
            {{-- Value 2 --}}
            <div class="group bg-white border border-gray-100 rounded-xl p-4 md:p-6 shadow-sm hover:shadow-xl transition duration-300 text-center">
                <div class="w-14 h-14 md:w-16 md:h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition duration-300">
            ...
            {{-- Value 3 --}}
            <div class="group bg-white border border-gray-100 rounded-xl p-4 md:p-6 shadow-sm hover:shadow-xl transition duration-300 text-center">
                <div class="w-14 h-14 md:w-16 md:h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition duration-300">
